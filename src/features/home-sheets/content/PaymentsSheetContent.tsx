...
function PaymentsContentInner({ presentation = 'screen', scrollOffsetOut, scrollRef }: SheetScreenProps) {
  ...
  return (
    <View style={styles.root}>
      <ScrollView
        ...
        <Segments dense labels={['Pay someone', 'Scan QR']} index={mode} onChange={setMode} />
        ...
        {mode === 0 ? (
          <>
            ...
            <AppText variant="secondary" tone={colors.textTertiary}>
              Payments can&apos;t be reversed. They&apos;re queued and signed by the treasury wallet,
              then confirmed on-chain — track them in Activity.
            </AppText>
          </>
        ) : (
 ...
 */
export const PaymentsSheetContent = memo(PaymentsContentInner);
