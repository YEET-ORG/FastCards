      ...
      return React.Children.map(children, (child) => {
        ...
        if (child.type === Shimmer || child.type === ShimmerEffect) {
          return React.cloneElement(child as React.ReactElement<any>, {
            isLoading,
            preset: (child.props as any).preset || preset,
            duration: (child.props as any).duration || duration,
            direction: (child.props as any).direction || direction,
            opacity: (child.props as any).opacity ?? opacity,
          });
        }

        if ((child.props as any) && (child.props as any).children) {
          return React.cloneElement(child as React.ReactElement<any>, {
            children: propagateProps((child.props as any).children),
          });
        }
